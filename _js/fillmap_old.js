...
var X_Lng=new Array();
	...
	X_Addr[44]="390 North Front Street";
	...
	X_Name[64]="SoftMoc Northgate Shopping Centre";

	X_Addr[64]="1500 Fisher St., Unit 141B";
	...
	X_Phone[64]="(705) 476-2022";

	X_Email[64]="softmoc62@softmoc.com";
	...
	X_Name[65]="SoftMoc Oakville Place";

	X_Addr[65]="240 Leighland Ave., Unit 243";
	...
	X_Phone[65]="(905) 337-0241";

	X_Email[65]="softmoc75@softmoc.com";
	...
	X_Name[66]="SoftMoc Place D'Orleans";

	X_Addr[66]="110 Place D'Orleans Dr., Unit 1060";
	...
	X_Phone[66]="(613) 590-1899";

	X_Email[66]="softmoc47@softmoc.com";
	...
	X_Name[67]="SoftMoc Oshawa Centre";

	X_Addr[67]="419 King St. West & Stevenson";
	...
	X_Phone[67]="(905) 436-0707";

	X_Email[67]="softmoc6@softmoc.com";
	...
	X_Name[68]="SoftMoc Billings Bridge Mall";

	X_Addr[68]="2269 Riverside Dr., Unit 171";
	...
	X_Phone[68]="(613) 249-8509";

	X_Email[68]="softmoc10@softmoc.com";
	...
	X_Name[69]="SoftMoc Carlingwood Mall";

	X_Addr[69]="2121 Carling Avenue";
	...
	X_Phone[69]="(613) 722-8447";

	X_Email[69]="softmoc11@softmoc.com";
	...
	X_Name[70]="SoftMoc St. Laurent Shopping Centre";

	X_Addr[70]="1200 Blvd. St. Laurent, Unit# 252";
	...
	X_Phone[70]="(613) 742-6209";

	X_Email[70]="softmoc17@softmoc.com";
	...
	X_Name[71]="SoftMoc Lansdowne Place";

	X_Addr[71]="645 Lansdowne St. West, Unit 143";

	X_City[71]="Peterborough";

	X_State[71]="ON";

	X_Zip[71]="K9J 7Y5";

	X_Phone[71]="(705) 743-9494";

	X_Email[71]="softmoc60@softmoc.com";
	...
	X_Name[72]="SoftMoc Pickering Town Centre";

	X_Addr[72]="1355 Kingston Road, Unit 202";
	...
	X_Phone[72]="(905) 831-7281";

	X_Email[72]="softmoc2@softmoc.com";
	...
	X_Name[73]="SoftMoc Hillcrest Mall";

	X_Addr[73]="9350 Yonge St., Unit E008";

	X_City[73]="Richmond Hill";

	X_State[73]="ON";

	X_Zip[73]="L4C 5G2";

	X_Phone[73]="(905) 737-2256";

	X_Email[73]="softmoc80@softmoc.com";
	...
	X_Name[74]="SoftMoc Scarborough Town Centre";

	X_Addr[74]="300 Borough Drive, Unit 69";

	X_City[74]="Scarborough";

	X_State[74]="ON";

	X_Zip[74]="M1P 4P5";

	X_Phone[74]="(416) 296-9187";

	X_Email[74]="softmoc21@softmoc.com";
	...
	X_Name[75]="SoftMoc Pen Centre";

	X_Addr[75]="221 Glendale Ave., Unit 115";

	X_City[75]="St. Catharines";

	X_State[75]="ON";

	X_Zip[75]="L2T 2K9";

	X_Phone[75]="(905) 988-9511";

	X_Email[75]="softmoc7@softmoc.com";
	...
	X_Name[76]="SoftMoc Shoe Rack St. Catharines";

	X_Addr[76]="First Pro Garden City, 420 Vansickle Road, Unit 6A";
	...
	X_Phone[76]="(905) 988-1671";

	X_Email[76]="softmoc302@softmoc.com";
	...
	X_Name[77]="SoftMoc Eastgate Mall";

	X_Addr[77]="75 Centennial Parkway North, Unit C1";

	X_City[77]="Stoney Creek";

	X_State[77]="ON";

	X_Zip[77]="L8E 2P2";

	X_Phone[77]="(905) 560-7483";

	X_Email[77]="softmoc55@softmoc.com";
	...
	X_Name[78]="SoftMoc New Sudbury Centre";

	X_Addr[78]="1349 LaSalle Blvd., Unit 56";
	...
	X_Phone[78]="(705) 525-0271";

	X_Email[78]="softmoc28@softmoc.com";
	...
	X_Name[79]="SoftMoc Promenade Mall";

	X_Addr[79]="1 Promenade Circle, Unit B233";
	...
	X_Phone[79]="(905) 886-3787";

	X_Email[79]="softmoc26@softmoc.com";
	...
	X_Name[80]="SoftMoc Intercity Shopping Centre";

	X_Addr[80]="1000  Fort Williams Road";

	X_City[80]="Thunder Bay";

	X_State[80]="ON";

	X_Zip[80]="P7B 6B8";

	X_Phone[80]="(807) 622-2543";

	X_Email[80]="softmoc20@softmoc.com";
	...
	X_Name[81]="SoftMoc Bloor St West";

	X_Addr[81]="2266 Bloor St. West";
	...
	X_Phone[81]="(416) 769-7231";

	X_Email[81]="softmoc46@softmoc.com";
	...
	X_Name[82]="SoftMoc Dufferin Mall";

	X_Addr[82]="900 Dufferin St., Unit 145";
	...
	X_Phone[82]="(416) 536-3850";

	X_Email[82]="softmoc69@softmoc.com";
	...
	X_Name[83]="SoftMoc Queen Street";

	X_Addr[83]="278A Queen St. West";
	...
	X_Phone[83]="(416) 977-7846";

	X_Email[83]="softmoc65@softmoc.com";
	...
	X_Name[84]="SoftMoc Toronto Eaton Centre";

	X_Addr[84]="220 Yonge Street, Level 1";
	...
	X_Phone[84]="(416) 595-0112";

	X_Email[84]="softmoc1@softmoc.com";
	...
	X_Name[85]="SoftMoc Yonge & Eglinton";

	X_Addr[85]="2299 Yonge St";
	...
	X_Phone[85]="(416) 482-9028";

	X_Email[85]="softmoc15@softmoc.com";
	...
	X_Name[86]="SoftMoc Yorkdale Shopping Centre";

	X_Addr[86]="3401 Dufferin Street, Unit 98";
	...
	X_Phone[86]="(416) 787-5212";

	X_Email[86]="softmoc63@softmoc.com";
	...
	X_Name[87]="SoftMoc Shoe Rack Vaughan Mills";

	X_Addr[87]="1 Bass Pro Mills Drive";
	...
	X_Phone[87]="(905) 738-9095";

	X_Email[87]="softmoc301@softmoc.com";
	...
	X_Name[88]="SoftMoc Conestoga Mall";

	X_Addr[88]="550 King Street North, Unit B1A";
	...
	X_Phone[88]="(519) 883-0220";

	X_Email[88]="softmoc64@softmoc.com";
	...
	X_Name[89]="SoftMoc Inc.";

	X_Addr[89]="1400 Hopkins Street, Units 3 & 4";
	...
	X_Phone[89]="(905) 665-8119";

	X_Email[89]="softmoc99@softmoc.com";
	...
	X_Name[90]="SoftMoc Fairview Mall";

	X_Addr[90]="1800 Sheppard Avenue E.";

	X_City[90]="Willowdale";

	X_State[90]="ON";

	X_Zip[90]="M2J 5A7";

	X_Phone[90]="(416) 497-1717";

	X_Email[90]="softmoc25@softmoc.com";
	...
	X_Name[91]="SoftMoc Devonshire Mall";

	X_Addr[91]="3100 Howard Avenue";
	...
	X_Phone[91]="(519) 250-1298";

	X_Email[91]="softmoc23@softmoc.com";
	...
	X_Name[92]="SoftMoc Shoe Rack Charlottetown";

	X_Addr[92]="670 University Avenue, Unit 101";

	X_City[92]="Charlottetown";

	X_State[92]="PE";

	X_Zip[92]="C1E 1H6";

	X_Phone[92]="(902) 892-2038";

	X_Email[92]="softmoc305@softmoc.com";
	...
	X_Name[93]="SoftMoc Carrefour Laval";

	X_Addr[93]="3035 Boul. Le Carrefour, Unit H010A";
	...
	X_Phone[93]="(450) 934-7463";

	X_Email[93]="softmoc82@softmoc.com";
	...
	X_Name[94]="SoftMoc Centre Rockland";

	X_Addr[94]="2305 Chemin Rockland, Unit 1750";

	X_City[94]="Mont-Royal";

	X_State[94]="QC";

	X_Zip[94]="H3P 3E9";

	X_Phone[94]="(514) 419-6697";
	...
	X_Name[95]="SoftMoc Les Galeries d'Anjou";

	X_Addr[95]="7999 Boul. Les-Galeries-d'Anjou, Unit E011";
	...
	X_Phone[95]="(438) 383-7638";

	X_Email[95]="softmoc83@softmoc.com";
	...
	X_Name[96]="SoftMoc St. Bruno";

	X_Addr[96]="1 Boul Des Promenades, Unit L10";
	...
	X_Phone[96]="(450) 482-6222";

	X_Email[96]="softmoc87@softmoc.com";
	...
	X_Name[97]="SoftMoc Cornwall Centre";

	X_Addr[97]="2102 11th Ave, Unit T035B";
	...
	X_Phone[97]="(306) 757-1035";

	X_Email[97]="softmoc74@softmoc.com";
	...
	X_Name[98]="SoftMoc Midtown Plaza";

	X_Addr[98]="201-1st Avenue South, Unit T231A";
	...
	X_Phone[98]="(306) 652-0999";

	X_Email[98]="softmoc73@softmoc.com";
...

{
	...
	var Tmp='<table border="0" cellspacing="0" cellpadding="0" class="deviceWidth">';
...

{
	...
	Tmp+='<td align="center" ><a href="storehomepage.asp?s=' + X_ID[i] + '" style="line-height:16px;text-decoration:none"><img border="0" src="http://www.softmoc.com/img/showstoredetail.gif"></a></td></tr>';
