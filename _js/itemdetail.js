...
jQuery(function ($) {
    ...
    $("#itemDetail360play").bind('click', function (e) {
        $("#closeMobile360btn a").css('display', 'block');
        play360();
    });
    ...
    $("#mobile360btn a").bind('click', function (e) {
        play360();
        $(this).css('display', 'none');
        $("#closeMobile360btn a").css('display', 'block');
        e.preventDefault();
    });
    $("#closeMobile360btn a").bind('click', function (e) {
        close360();
        $(this).css('display', 'none');
        $("#mobile360btn a").css('display', 'block');
        e.preventDefault();
    });
    ...
    var myCustomPager = "";
    var myInfiniteLoop = true;
    if (isResponsive === false) {
        myCustomPager = '#itemDetailThumbs';
        myInfiniteLoop = false;
    }
    ...
    function resizeActions(){
        $('#mobile360btn a').css('display', 'block');
        $('#closeMobile360btn a').css('display', 'none');
    ...
    $.magnificPopup.open({
                    ...
                    '<div class="qvLeftColumn qvMainImg"></div>'+
                        '<div class="qvRightColumn">'+
                            ...
                            '<div class="qvAddtoCartButton">'+
                                '<a href="#" class="addToCartButton"><i class="fa fa-shopping-cart fa-lg"></i> Add to Cart</a>'+
                            '</div>'+
      ...
      callbacks: {
        ...
        markupParse: function(template, values) {
          var qvobject = {
            qv_id: "<strong>Item ID:</strong> "+values.item_id,
